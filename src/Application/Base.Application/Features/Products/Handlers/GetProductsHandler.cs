...
namespace Base.Application.Features.Products.Handlers
{
    ...
    public class GetProductsHandler : IRequestHandler<GetProductsQuery, PaginatedProductResponse>
    {
        private readonly IProductRepository _repo;
        private readonly IMapper _mapper;

        public GetProductsHandler(IProductRepository repo, IMapper mapper)
        {
            _repo = repo;
            _mapper = mapper;
        }
